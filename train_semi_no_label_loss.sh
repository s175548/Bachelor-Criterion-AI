...
python3 semantic_segmentation/semi_supervised/exp_gen_semi.py 0.003 DeepLab SGD False semi_GAN_setup semi_super/GAN_regular_no_loss_label True True True
echo "Done"