...
for i in range(len(train_images)):
    ...
    PIL.Image.fromarray(image.astype(np.uint8)).save(save_path + r'{}_img.png'.format(file_names_val[i]),format='PNG')
    PIL.Image.fromarray(pred_color.astype(np.uint8)).save(save_path +  r'{}_pred_color.png'.format(file_names_val[i]),format='PNG')
    PIL.Image.fromarray(target_color.astype(np.uint8)).save(save_path + r'{}_mask_color.png'.format(file_names_val[i]),format='PNG')
