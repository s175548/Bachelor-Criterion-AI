...
crop_values=json.load(params_list)
for i in range(len(train_images)):
    print(i)
    crop_value=crop_values[file_names_val[i]]
    ...
    errors, false_positives, metric, target_color, pred_color,true_negatives = error_count(int(file_names_val[i]), pred.copy(),
                                                                            ...
                                                                            false_positives,true_negatives, metrics, resize,crop_values=crop_value, size=size,
