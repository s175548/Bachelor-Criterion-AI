...
if __name__ == "__main__":
    if HPC:
        path_label = r'/work3/s173934/Bachelorprojekt\cropped_data\mask'
        ...
        path_label = r'C:\Users\Mads-_uop20qq\Documents\5. Semester\BachelorProj\Bachelorprojekt\cropped_data\mask'
    ...
    transform_function = et.ExtCompose([et.ExtScale(224),
                    et.ExtToTensor(),
    ...
    train_dst = LeatherData(path_label=path_label,path_img=path_img,list_of_filenames=file_names[:round(N_files*0.80)], transform=transform_function)
