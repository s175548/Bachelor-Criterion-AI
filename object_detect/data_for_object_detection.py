...
class DataLoader():
    def __init__(self,data_path=r'C:\Users\johan\OneDrive\Skrivebord\leather_patches',metadata_path = r'.samples\model_comparison.csv'):
...
resized1 = cv2.resize(img_tests[0], (300,300), interpolation = cv2.INTER_AREA)
resized2 = cv2.resize(img_tests[0], (300,300), interpolation = cv2.INTER_AREA)
resized3 = cv2.resize(img_tests[0], (300,300), interpolation = cv2.INTER_AREA)
resized = [resized1, resized2]
