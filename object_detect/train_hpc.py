...
transform_function = et.ExtCompose([et.ExtRandomCrop(scale=0.5),et.ExtRandomHorizontalFlip(p=0.5),et.ExtRandomVerticalFlip(p=0.5),et.ExtEnhanceContrast(),et.ExtToTensor()])
