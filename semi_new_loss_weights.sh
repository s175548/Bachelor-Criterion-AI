...
python3 semantic_segmentation/semi_supervised/exp_gen_semi.py 0.003 DeepLab SGD False semi_new_weights semi_super/different_loss_weights True True False
echo "Done"