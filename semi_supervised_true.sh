...
python3 semantic_segmentation/semi_supervised/exp_gen_semi.py 0.005 DeepLab Adam False semi_spectral semi_super/spectral/own_loss_all_layers True True False
echo "Done"